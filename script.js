...
// Exercício 2
let num3 = parseFloat(prompt("Fale um número:"));
let num4 = parseFloat(prompt("Fale um número:"));
...
let area = parseFloat(prompt("Informe sua área em Acre(s):"));
let custo1 = 50 * area;
let custo2 = 100 * area;
let custo3 = 150 * area;
let custo4 = 250 * area;
...
if(tempo1 != 0 || tempo1 != parseFloat(tempo1)){
